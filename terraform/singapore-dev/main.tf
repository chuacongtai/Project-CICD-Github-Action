...
module "ecs_cluster"{
  ...
  nodejs_target_group_arn_blue = module.load_balance.target_group_blue_arn
  nodejs_target_group_arn_green = module.load_balance.target_group_green_arn
